...
/****** Object: Table [SalesLT].[SalesOrderHeader] Script Date: 4/15/2017 9:59:12 AM ******/
SET ANSI_NULLS ON
GO
...
GO
ALTER TABLE [SalesLT].[SalesOrderHeader]
    ADD CONSTRAINT [AK_SalesOrderHeader_SalesOrderNumber] UNIQUE NONCLUSTERED ([SalesOrderNumber] ASC);
